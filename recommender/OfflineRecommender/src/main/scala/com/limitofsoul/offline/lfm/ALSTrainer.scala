...
import com.limitofsoul.offline.{Common, MongoConfig, MovieRating}
...
/**
 *
 * TODO:ALS模型评估和参数选择 rank, iterations, lambda
 */

object ALSTrainer {
  def main(args: Array[String]): Unit = {

    val sparkConf = new SparkConf().setMaster(Common.config("spark.cores")).setAppName("ALSTrainer")
